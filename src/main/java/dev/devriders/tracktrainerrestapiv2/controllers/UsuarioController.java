...
public class UsuarioController {
    ...
    public ResponseEntity<List<UsuarioModel>> buscarPorNickname(@PathVariable String nickname) {
        List<UsuarioModel> usuarios = usuarioRepository.findByNicknameLike("%" + nickname + "%");
        if (usuarios.isEmpty()) {
